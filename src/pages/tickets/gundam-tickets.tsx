...
const Page: NextPage = () => {
  ...
  const mikeTickets = {
    entrance: <img src="/assets/qr/gundam/mike_entrance.png" width="100%" />,
    ...
    dock: <img src="/assets/qr/gundam/mike_dock.png" width="100%" />,
    dockNumber: "610576",
    dockUrl:
  ...
  const feeTickets = {
    entrance: <img src="/assets/qr/gundam/fee_entrance.png" width="100%" />,
    ...
    dock: <img src="/assets/qr/gundam/fee_dock.png" width="100%" />,
    dockNumber: "304519",
    dockUrl:
  ...
  const natTickets = {
    entrance: <img src="/assets/qr/gundam/nat_entrance.png" width="100%" />,
  ...
  const megTickets = {
    entrance: <img src="/assets/qr/gundam/meg_entrance.png" width="100%" />,
