...
type MoveTaskAction = PayloadAction<{
  taskId: string;
  position: number;
  columnId?: string;
}>;
...
type AddChecklistAction = PayloadAction<{
  taskId: string;
  checklist: Checklist;
}>;

type UpdateChecklistAction = PayloadAction<{
  taskId: string;
  checklist: Checklist;
}>;

type DeleteChecklistAction = PayloadAction<{
  taskId: string;
  checklistId: string;
}>;
